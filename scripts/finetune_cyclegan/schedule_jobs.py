...
OUTPUT_ROOT='/scratch/cluster/pkar/text-style-transfer/cyclegan/tmp/finetune_cyclegan_ablation_1k'
SCRIPT_ROOT='/scratch/cluster/pkar/text-style-transfer/cyclegan/scripts/finetune_cyclegan'
...
mapping_dict = { 
    ...
    '__SHUFFLE__': 'True',
    '__TRAIN_MODE__': 'finetune_cyclegan',
    '__EMBEDDING_SIZE__': '300',
    '__HIDDEN_SIZE__': '350',
    '__NUM_RNN_LAYERS__': '1',
    '__USE_LSTM__': 'True',
    '__USE_ATTENTION__': 'True',
    '__EPOCHS__': '100',
    '__LEARNING_RATE__': '5e-6',
    ...
    '__NUM_SEARCHES__': '1',
    '__G_UPDATE_STEP_DIFF__': '25',
    '__D_UPDATE_STEP_DIFF__': '1',
    '__LR_RATIO_D_BY_G__': '2.0',
    '__DISCOUNT_FACTOR__': '0.99',
    '__LAMDA_RL__': ['1e-1', '1e-0', '0.0', '1e-1', '1e-0'],
    '__LAMDA_REC_II__': '1e-2',
    '__LAMDA_REC_IJ__': ['0.0', '0.0', '1e-3', '1e-3', '1e-3'],
    '__LAMDA_COS_IJ__': '0.0',
    '__SKIP_WEIGHT_DECAY__': '0.995',
    '__FREEZE_EMBEDDINGS__': 'True',
    '__CLAMP_LOWER__': '-0.01',
    '__CLAMP_UPPER__': '0.01',
    '__D_PRETRAIN_NUM_EPOCHS__': '3',
    '__DISC_RECALIBRATE__': '400',  
    '__G_UPDATE_STEP_DIFF_RECALIB__': '200'
    }
